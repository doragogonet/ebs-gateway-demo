...
INSERT INTO `readers` VALUES (1,'zebra_fx9600',NULL,'192.168.31.100',NULL,'1','',NULL,'',NULL,'zebra_fx9600.jpg');
...
CREATE TABLE `rfid_data` (
  ...
  `tag_time` varchar(20) NOT NULL COMMENT 'タグ時間',
  `create_by` varchar(64) DEFAULT '' COMMENT '作成者',
  `create_time` datetime DEFAULT NULL COMMENT '作成時間',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新時間',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='RFIDデータテーブル';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='システムアクセスレコード';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_online` VALUES ('266627fb-3379-475b-8628-a45ab5184f3b','admin','開発部','127.0.0.1','内部IP','Chrome 12','Windows 10','on_line','2024-07-29 10:59:55','2024-07-29 11:45:37',1800000);
...
-- Dump completed on 2024-08-07 19:14:52
