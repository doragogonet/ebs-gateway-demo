package com.ebs.common.utils.poi;
...
import com.ebs.common.annotation.Excel.Type;
import com.ebs.common.annotation.Excels;
...
import com.ebs.common.utils.file.FileTypeUtils;
import com.ebs.common.utils.file.FileUtils;
import com.ebs.common.utils.file.ImageUtils;
import com.ebs.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel(InputStream is)
    {
        ...
        {
            log.error("Excel異常{}", e.getMessage());
    ...
    public List<T> importExcel(String sheetName, InputStream is, int titleNum) throws Exception
    {
        ...
        if (sheet == null)
        {
            throw new IOException("ファイルsheetが存在しない");
        }
    ...
    public AjaxResult exportExcel()
    {
        ...
        {
            log.error("Excel異常{}", e.getMessage());
            throw new UtilException("Excel操作失敗");
        }
        finally
        {
            IOUtils.closeQuietly(wb);
    ...
    public String dataFormatHandlerAdapter(Object value, Excel excel, Cell cell)
    {
        ...
        {
            log.error("エラー " + excel.handler(), e.getMessage());
        }
    ...
    {
        String downloadPath = EbsConfig.getDownloadPath() + filename;
